...
#Region "Functions"
    ...
    Public Function DBContextCreateNew(connection As SqlConnection) As DBs.AppDbDataContext
        Try
            Dim mDBContext = New DBs.AppDbDataContext(connection)
            mDBContext.CommandTimeout = 0 'AppBase.AppConnectionInfor.ConnectionTimeOut
            Return mDBContext
        Catch ex As Exception
            Return Nothing
