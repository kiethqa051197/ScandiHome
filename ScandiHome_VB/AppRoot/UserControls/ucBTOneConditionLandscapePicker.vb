...
<ToolboxItem(True)>
Public Class ucBTOneConditionLandscapePicker
...
#Region "Declares"
    ...
    Public Event ConditionValuesChanged(ByVal pValueFrom As Object, ByVal pValueTo As Object, ByVal pValues As Object)
    Public Event SQLConditionValuesChanged(ByVal pValueFrom As String, ByVal pValueTo As String, ByVal pValues As String)
...
#Region "Properties"
    ...
    Public Property MyFirstLabelWidth() As Single
        Get
            Return tlpLayout.ColumnStyles(0).Width
        End Get
        Set(ByVal value As Single)
            tlpLayout.ColumnStyles(0).Width = value
        End Set
    End Property
    Public Property MyFirstComboWidth() As Integer
        Get
            Return tlpLayout.ColumnStyles(1).Width
        End Get
        Set(ByVal value As Integer)
            tlpLayout.ColumnStyles(1).Width = value
        End Set
    End Property
    Public Property MySecondLabelWidth() As Single
        Get
            Return tlpLayout.ColumnStyles(2).Width
        End Get
        Set(ByVal value As Single)
            tlpLayout.ColumnStyles(2).Width = value
        End Set
    End Property
    Public Property MySecondComboWidth() As Integer
        Get
            Return tlpLayout.ColumnStyles(3).Width
        End Get
        Set(ByVal value As Integer)
            tlpLayout.ColumnStyles(3).Width = value
        End Set
    End Property
...
#Region "Subs"
    ...
    Private Sub RefreshCodeIDComboWidth()
        ...
        If Not cboCodeIDFrom.Properties.DataSource Is Nothing Then
            Dim mDataCount = CType(cboCodeIDFrom.Properties.DataSource, DataTable).Rows.Count
    ...
    Public Sub ResetValue()
        ...
        RaiseEvent ConditionValuesChanged(cboCodeIDFrom.EditValue, cboCodeIDTo.EditValue, chkcboCodeIDs.EditValue)
        RaiseEvent SQLConditionValuesChanged(GetSQL_CodeIDConditionFrom, GetSQL_CodeIDConditionTo, GetSQL_CodeIDCheck)
    End Sub
...
#Region "Controls Events"
    ...
    Private Sub chkcboCodeIDs_CloseUp(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.CloseUpEventArgs) Handles chkcboCodeIDs.CloseUp
        RaiseEvent ConditionValuesChanged(cboCodeIDFrom.EditValue, cboCodeIDTo.EditValue, chkcboCodeIDs.EditValue)
        RaiseEvent SQLConditionValuesChanged(GetSQL_CodeIDConditionFrom, GetSQL_CodeIDConditionTo, GetSQL_CodeIDCheck)
    End Sub
